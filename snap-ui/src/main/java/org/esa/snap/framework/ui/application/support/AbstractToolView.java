...
import org.esa.snap.framework.ui.application.PageComponentContext;
import org.esa.snap.framework.ui.application.PageComponentDescriptor;
...
/**
 * An abstract base class for client {@link org.esa.snap.framework.ui.application.ToolView}s.
...
public abstract class AbstractToolView extends AbstractControlFactory implements ToolView {
    ...
    /**
     * Sets the actual window title which may be different from what {@link org.esa.snap.framework.ui.application.PageComponentDescriptor#getTitle()} returns.
     *

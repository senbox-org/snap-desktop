...
@OptionsPanelController.TopLevelRegistration(
        ...
        keywordsCategory = "ZNAP",
        position = 1600
)

@org.openide.util.NbBundle.Messages({
        "AdvancedOption_DisplayName_Writer=ZNAP",
        "AdvancedOption_Keywords_Writer=data,znap,zarr,io,reader,writer"
})
...
public final class WriterOptionsPanelController extends OptionsPanelController {
    ...
    public HelpCtx getHelpCtx() {
        return new HelpCtx("exportZnapProduct"); // new HelpCtx("...ID") if you have a help set
    }

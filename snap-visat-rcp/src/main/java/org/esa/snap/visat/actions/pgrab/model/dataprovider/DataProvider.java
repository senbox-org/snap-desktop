 ...
 */
package org.esa.snap.visat.actions.pgrab.model.dataprovider;
...
public interface DataProvider {
     ...
     * Created data can be stored into a {@link org.esa.snap.util.PropertyMap PropertyMap} retrieved by calling
     * {@link org.esa.snap.visat.actions.pgrab.model.Repository#getPropertyMap() Repository.getPropertyMap()}
     * or in a directory retrieved from
     * {@link org.esa.snap.visat.actions.pgrab.model.Repository#getStorageDir() Repository.getStorageDir()}.
     *
     * @param entry      the entry for which the data shall be provided.

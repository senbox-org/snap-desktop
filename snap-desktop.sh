...
PROGRAM_ARGS="--userdir $CWD/snap-application/target/userdir --clusters $CWD/../s1tbx/s1tbx-kit/target/netbeans_clusters/s1tbx:$CWD/../s2tbx/s2tbx-kit/target/netbeans_clusters/s2tbx --patches $CWD/../snap-engine/$/target/classes:$CWD/../s1tbx/$/target/classes:$CWD/../s2tbx/$/target/classes"

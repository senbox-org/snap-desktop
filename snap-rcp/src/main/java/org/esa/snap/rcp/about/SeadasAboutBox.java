...
//    private static String SEADAS_VERSION = "8.0.0-Beta";
    ...
    private final static String RELEASE_NOTES_URL = "https://github.com/seadas/seadas-toolbox/blob/master/docs/ReleaseNotes/SeaDAS-8.0.0-Beta.md";
...
//                + "<b>SNAP Engine implementation version: </b>" + engineModuleInfo.getImplementationVersion() + "<br>"
                + "<b>SNAP Desktop implementation version: </b>SEADAS-8.0.0 (branded from SNAP 8.0.1)<br>"
                + "<b>SNAP Desktop git repository branch: </b>https://github.com/senbox-org/snap-desktop/tree/SEADAS-8.0.0-SNAP-8.0.1<br>"
//                + "<b>SNAP Desktop implementation version: </b>" + desktopModuleInfo.getImplementationVersion() + "-seadas" + SEADAS_VERSION +"<br>"
                + "<b>SNAP Engine implementation version: </b>SEADAS-8.0.0 (branded from SNAP 8.0.1)<br>"
                + "<b>SNAP Engine git repository branch: </b>https://github.com/senbox-org/snap-engine/tree/SEADAS-8.0.0-SNAP-8.0.1<br>"

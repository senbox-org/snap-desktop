...
public class SpectralNoiseReductionProfilesDialog extends JDialog {
    ...
    private final SpectralNoiseSettingsPanel settingsPanel = new SpectralNoiseSettingsPanel();
    ...
    private final JTextField suffixField = new JTextField("_smoothed", 18);
    ...
    private SpectralNoiseReductionProfilesDialog(Window owner,
                                                 String activeLibraryName,
                                                 int selectedProfileCount) {
        super(owner, "Reduce Spectral Noise", ModalityType.APPLICATION_MODAL);
    ...
    public static Optional<Result> showDialog(Component parent,
        ...
        SpectralNoiseReductionProfilesDialog dialog =
                new SpectralNoiseReductionProfilesDialog(owner, activeLibraryName, selectedProfileCount);

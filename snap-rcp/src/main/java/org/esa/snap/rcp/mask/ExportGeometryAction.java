...
@ActionID(
        category = "File",
        id = "org.esa.snap.rcp.mask.ExportGeometryAction"
)
@ActionRegistration(
...
public class ExportGeometryAction extends AbstractAction implements LookupListener,ContextAwareAction,HelpCtx.Provider{
    ...
    private void exportVectorDataNode() {
        ...
        final ProductNode productNode = snapApp.getSelectedProductNode();

...
public final class GeoLocationController extends DefaultConfigController {
    ...
    protected JPanel createPanel(BindingContext context) {
        ...
        final Property pixelGeoCodingFractionInterpolatorProperty = propertySet.getProperty(SYSPROP_INTERPOLATOR_GEODETIC);
    ...
    static class GeoLocationBean {
        ...
        @Preference(label = "Use geodetic interpolation for sub-pixel fraction accuracy for pixel-based geo-coding",
                key = SYSPROP_INTERPOLATOR_GEODETIC, config = "snap")
        boolean useGeodeticInterpolator = false;

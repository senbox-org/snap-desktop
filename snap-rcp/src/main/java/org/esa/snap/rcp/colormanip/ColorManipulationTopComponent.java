...
@NbBundle.Messages({
        "CTL_ColorManipulationTopComponent_Name=" + ColorSchemeDefaults.TOOLNAME_COLOR_MANIPULATION,
        "CTL_ColorManipulationTopComponent_ComponentName=" + ColorSchemeDefaults.TOOLNAME_COLOR_MANIPULATION
})
/**

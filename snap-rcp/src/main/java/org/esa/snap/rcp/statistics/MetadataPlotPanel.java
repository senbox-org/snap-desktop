...
class MetadataPlotPanel extends ChartPagePanel {
    ...
    private final static String PROPERTY_NAME_X_METADATA = "xMetadata";
    private final static String PROPERTY_NAME_Y_METADATA = "yMetadata";
    ...
    private void initActionEnablers() {
        RefreshActionEnabler roiMaskActionEnabler = new RefreshActionEnabler(refreshButton, PROPERTY_NAME_X_PRODUCT, PROPERTY_NAME_Y_PRODUCT,
                                                                             PROPERTY_NAME_X_METADATA, PROPERTY_NAME_Y_METADATA);
    ...
    private void initParameters() {
        ...
        bindingContext.bind(PROPERTY_NAME_X_METADATA, xBandList);
        ...
        xBandProperty = bindingContext.getPropertySet().getProperty(PROPERTY_NAME_X_METADATA);

        yBandList = new JComboBox<>();
        yBandList.setRenderer(new BandListCellRenderer());
        bindingContext.bind(PROPERTY_NAME_Y_METADATA, yBandList);
        yBandProperty = bindingContext.getPropertySet().getProperty(PROPERTY_NAME_Y_METADATA);
    }
    ...
    protected void updateChartData() {
        ...
        final RasterDataNode xMetadata = dataSourceConfig.xMetadata;
        final RasterDataNode yMetadata = dataSourceConfig.yMetadata;
        ...
        ProgressMonitorSwingWorker<BufferedImage, Object> swingWorker = new ProgressMonitorSwingWorker<BufferedImage, Object>(
            ...
            protected BufferedImage doInBackground(ProgressMonitor pm) throws Exception {
                ...
                try {
                    checkBandsForRange();
                    setRange(X_VAR, xMetadata, null, SubProgressMonitor.create(pm, 15));
                    setRange(Y_VAR, yMetadata, null, SubProgressMonitor.create(pm, 15));
                    final BufferedImage densityPlotImage = ProductUtils.createDensityPlotImage(xMetadata,
            ...
            public void done() {
                try {
                    ...
                    plot.getDomainAxis().setLabel(StatisticChartStyling.getAxisLabel(dataSourceConfig.xMetadata, "X", false));
                    plot.getRangeAxis().setLabel(StatisticChartStyling.getAxisLabel(dataSourceConfig.yMetadata, "Y", false));
    ...
    protected String getDataAsText() {
        ...
        final RasterDataNode rasterX = dataSourceConfig.xMetadata;
        assert rasterX != null;
        final String nameX = rasterX.getName();
        final double sampleMinX = bounds.getMinX();
        final double sampleMaxX = bounds.getMaxX();

        final RasterDataNode rasterY = dataSourceConfig.yMetadata;
        assert rasterY != null;
    ...
    private static class DataSourceConfig {
        ...
        private RasterDataNode xMetadata;
        private RasterDataNode yMetadata;
        private Property xProductProperty;
        private Property xBandProperty;
    }

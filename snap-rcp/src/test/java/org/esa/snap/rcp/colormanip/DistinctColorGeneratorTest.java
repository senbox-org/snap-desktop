...
public class DistinctColorGeneratorTest {

  @Test
  public void testGetNextDistinctColor_returnsColorsInCorrectOrder() {
    DistinctColorGenerator generator = new DistinctColorGenerator();
  ...
  public void testConstructorWithCustomColors_usesProvidedColors() {
    ...
    DistinctColorGenerator generator = new DistinctColorGenerator(customColors);

...
public class UnmountWindowsLocalDriveTimerRunnable extends AbstractTimerRunnable<Void> {
    ...
    public UnmountWindowsLocalDriveTimerRunnable(LoadingIndicator loadingIndicator, int threadId, String localSharedDrive, IUnmountLocalSharedFolderCallback callback) {

...
package org.esa.snap.gui.actions.interactors;
...
@ActionID(
        ...
        id = "org.esa.snap.gui.action.interactors.PannerToolAction"
)
@ActionRegistration(
...
public class PannerToolAction extends ToolAction {
    ...
    public PannerToolAction(Lookup lookup) {
        ...
        putValue(SMALL_ICON, ImageUtilities.loadImageIcon("org/esa/snap/gui/icons/PannerTool24.gif", false));
        putValue("helpId", "panTool");

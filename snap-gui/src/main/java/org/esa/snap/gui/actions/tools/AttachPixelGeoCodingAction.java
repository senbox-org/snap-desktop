...
@ActionID(
        category = "Tools",
        id = "org.esa.snap.gui.actions.tools.AttachPixelGeoCodingAction"
)
@ActionRegistration(
    ...
    private static void attachPixelGeoCoding(final Product product) {
        ...
        if (freeMegas < requiredMegas) {
            final String message = MessageFormat.format("This operation requires to load at least {0} M\n" +
                                                        ...
                                                        requiredMegas);
            final int answer = snapApp.showQuestionDialog(dialogTitle, message, null);
        ...
        final ProgressMonitorSwingWorker<Void, Void> swingWorker = new ProgressMonitorSwingWorker<Void, Void>(mainFrame, dialogTitle) {
            ...
            public void done() {
                try {
                    get();
                    snapApp.showInfoDialog(dialogTitle, "Pixel geo-coding has been attached.", null);
                } catch (Exception e) {
                    Throwable cause = e;
                    ...
                    snapApp.showErrorDialog(dialogTitle, msg);
                } finally {

 ...
 */
public class SelectAllActionExt implements ProductLibraryActionExt {
    ...
    public JButton getButton(final JPanel panel) {
        if (button == null) {
            button = DialogUtils.createButton("selectAllButton", "Select all products", selectAllIcon, panel, DialogUtils.ButtonStyle.Icon);
        }
        return button;
    }
    ...
    public void performAction(final ProgressMonitor pm) {
        actionHandler.getToolView().selectAll();
    }
}

...
public class RepositoryAddressValidator implements Validator {
    ...
    public boolean isValid(String repositorySchema) {
        return Pattern.compile(REPOSITORY_ADDRESS_VALIDATOR_PATTERN).matcher(repositorySchema).matches();
    }

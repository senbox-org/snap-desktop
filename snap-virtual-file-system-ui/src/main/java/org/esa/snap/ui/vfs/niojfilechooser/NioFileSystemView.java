...
//     */
//    private Map<String, VirtualFileSystemHelper> vfsFileSystemViews;
//
//    /**
...
//
//    private static Logger logger = Logger.getLogger(VirtualFileSystemHelper.class.getName());
//
//    static {
//        try {
...
//        VirtualFileSystemHelper vfsFileSystemView = vfsFileSystemViews.get(dir.getPath());
...
//        for (Map.Entry<String, VirtualFileSystemHelper> entry : this.vfsFileSystemViews.entrySet()) {
//            VirtualFileSystemHelper value = entry.getValue();
